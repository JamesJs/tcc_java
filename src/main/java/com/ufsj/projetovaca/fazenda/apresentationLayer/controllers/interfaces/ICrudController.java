package com.ufsj.projetovaca.fazenda.apresentationLayer.controllers.interfaces;
...
public abstract class ICrudController<Input,Output,Entidade> {
	...
	public abstract ResponseEntity<?> criar(Input t);
	public abstract ResponseEntity<?> deletar(Long id);
	public abstract ResponseEntity<?> atualizar(Input t,Long id);
